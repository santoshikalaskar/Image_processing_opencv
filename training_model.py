...
detector = cv2.CascadeClassifier("/home/admin238/Downloads/Face-Recognition-Lock-Unlock-Screen/haarcascade_frontalface_default.xml")
...
faces,ids = getImagesAndLabels('/home/admin238/Downloads/Face-Recognition-Lock-Unlock-Screen/dataset')  # Get the faces and IDs

recognizer.train(faces, np.array(ids)) # Train the model using the faces and IDs

assure_path_exists('/home/admin238/Downloads/Face-Recognition-Lock-Unlock-Screen/trainer/')    # Save the model into trainer.yml
recognizer.save('/home/admin238/Downloads/Face-Recognition-Lock-Unlock-Screen/trainer/trainer.yml')
