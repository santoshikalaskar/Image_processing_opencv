...
face_cascade = cv2.CascadeClassifier('/home/admin238/Downloads/Face-Recognition-Lock-Unlock-Screen/haarcascade_frontalface_default.xml') # Detect object in video stream using Haarcascade Frontal Face
...
while(True):
    ...
    elif count>400:                                     # If image taken reach 100, stop taking video
        break
